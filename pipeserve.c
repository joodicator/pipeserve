 ...
 *
 *  - The controlling terminal of pipeserve, if any, is inherited by the
 *    child process: if the child process preserves this, then typing
 *    Control-C on the terminal sends an interrupt signal to the child,
 *    and is ignored by pipeserve.
 *
